...
var jetpackLazyImagesModule = function(t) {
  function e() {
      if (i = document.querySelectorAll("img.jetpack-lazy-image:not(.jetpack-lazy-image--handled)"), u = i.length, s && s.disconnect(), "IntersectionObserver" in window)
          for (s = new IntersectionObserver(r, h), a = 0; a < i.length; a++) c = i[a], c.getAttribute("data-lazy-loaded") || s.observe(c);
      else n(i)
  }
  ...
  function r(t) {
      ...
      for (0 === u && s.disconnect(), e = 0; e < t.length; e++) {
          var n = t[e];
          n.intersectionRatio > 0 && (u--, s.unobserve(n.target), o(n.target))
      }
  }

  function o(e) {
      var n, r, o, i = t(e);
      i.length && (n = i.attr("data-lazy-srcset"), r = i.attr("data-lazy-sizes"), o = i.clone(), o.removeAttr("data-lazy-srcset"), o.removeAttr("data-lazy-sizes"), o.removeAttr("data-lazy-src"), o.addClass("jetpack-lazy-image--handled"), o.attr("data-lazy-loaded", 1), n ? o.attr("srcset", n) : o.removeAttr("srcset"), r && o.attr("sizes", r), i.replaceWith(o), o.trigger("jetpack-lazy-loaded-image"))
  }
  var i, s, c, a, h = {
  ...
  t(document).ready(function() {
      e(), t("body").bind("post-load", e), t("body").bind("jetpack-lazy-images-load", e)
  })
};
/**
...
! function(t, e) {
  ...
  r.prototype.THROTTLE_TIMEOUT = 100, r.prototype.POLL_INTERVAL = null, r.prototype.USE_MUTATION_OBSERVER = !0, r.prototype.observe = function(t) {
      ...
      this._observationTargets.forEach(function(r) {
          ...
          a ? t && c ? this._hasCrossedThreshold(a, l) && this._queuedEntries.push(l) : a && a.isIntersecting && this._queuedEntries.push(l) : this._queuedEntries.push(l)
      }, this), this._queuedEntries.length && this._callback(this.takeRecords(), this)
  }, r.prototype._computeTargetAndRootIntersection = function(n, r) {
      if ("none" != t.getComputedStyle(n).display) {
          for (var o = h(n), i = o, s = d(n), c = !1; !c;) {
              var u = null,
                  l = 1 == s.nodeType ? t.getComputedStyle(s) : {};
              if ("none" == l.display) return;
              if (s == this.root || s == e ? (c = !0, u = r) : s != e.body && s != e.documentElement && "visible" != l.overflow && (u = h(s)), u && !(i = a(u, i))) break;
              s = d(s)
          }
          return i
      }
